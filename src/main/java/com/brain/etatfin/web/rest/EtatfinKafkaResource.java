...
@RestController
@RequestMapping("/api/etatfin-kafka")
public class EtatfinKafkaResource {
    private final Logger log = LoggerFactory.getLogger(EtatfinKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EtatfinKafkaResource(KafkaProperties kafkaProperties) {
